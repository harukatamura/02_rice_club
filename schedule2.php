			...
			<table>
				...
				<?php 
					...
					if ($editflg == 0){
						...
						$query = $query."  (  ";
						$query = $query."    SELECT  ";
						$query = $query."    A.date,B.staff,B.displayname,B.team, B.vacation, B.phonetic, B.staffno ";
						...
						$query = $query."    ,  ";
						$query = $query."    (  ";
						$query = $query."     SELECT a.staff,a.displayname,IFNULL(b.team, 'その他') as team, a.vacation, a.phonetic  ,1 as staffno";
						$query = $query."     FROM php_staff_info a ";
						$query = $query."     LEFT OUTER JOIN php_staff b ";
						$query = $query."       ON a.displayname=b.staff ";
						$query = $query."     WHERE a.delflg = 0 ";
					...
					$query = $query."            , a.vacation, a.phonetic  ,10 as staffno ";
